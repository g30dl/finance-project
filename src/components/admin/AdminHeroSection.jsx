...
function AdminHeroSection({
  ...
  return (
    <div className="grid gap-4 sm:gap-6 lg:grid-cols-[1.35fr_1fr]">
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-primary via-primary-dark to-accent p-6 sm:p-8 text-white shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <h2 className="mt-2 font-heading text-3xl font-bold sm:text-5xl">
          ...
          <div className="mt-4 flex flex-wrap gap-3 sm:mt-6 sm:gap-4">
            <div className="rounded-2xl border border-white/20 bg-white/10 px-4 py-3 backdrop-blur-sm">
              ...
              <p className="font-heading text-base sm:text-lg">{formatCurrency(casaBalance)}</p>
            </div>
            <div className="rounded-2xl border border-white/20 bg-white/10 px-4 py-3 backdrop-blur-sm">
              <span className="text-xs text-white/70">Cuentas personales</span>
              <p className="font-heading text-base sm:text-lg">{formatCurrency(personalTotal)}</p>
            </div>
          </div>
        </div>
      </div>

      <div className="rounded-2xl sm:rounded-3xl border border-white/40 bg-white/70 p-4 sm:p-5 shadow-card backdrop-blur-xl">
        <h3 className="mb-4 font-heading text-base sm:text-lg text-foreground">Acciones rapidas</h3>
        <QuickActionsGrid
          onDeposit={onDeposit}
